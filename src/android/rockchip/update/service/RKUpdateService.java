...
public class RKUpdateService extends Service {
    ...
    private boolean requestRemoteServerForUpdate()
            throws IOException, ClientProtocolException, KeyStoreException, FileNotFoundException, IOException, NoSuchAlgorithmException, CertificateException, KeyManagementException, UnrecoverableKeyException {
        ...
        mTargetURI = "https://" + getRemoteHost() +
